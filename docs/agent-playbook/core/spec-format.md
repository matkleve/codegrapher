...
Governance: project `docs/specs/README.md`.
...
- Parent spec cap: **180 lines** (typical `lint-specs` script)
...
- Timing constants: cite the code file, not rounded prose alone.
- Colors: token names only — see project `docs/design/tokens.md`.
