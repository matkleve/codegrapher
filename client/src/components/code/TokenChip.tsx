  ...
  function TokenChip(
    ...
    return (
      <span
        ...
        tabIndex={tabIndex}
        className={cn(
          "relative inline-flex items-center overflow-visible rounded-sm border border-transparent px-1 py-0 text-[11px] align-baseline leading-none transition-all duration-100",
          TOKEN_TEXT[semantic],
          active && TOKEN_BORDER[semantic],
