...
/**
 * The left dot on a code line's target handle. Isolated into its own leaf so
 * CodeLine itself doesn't subscribe to volatile trace state — only this tiny
 * component re-renders when a preview edge lands on the line.
 */
function LineTargetAnchorComponent({ targetId }: { targetId: string }) {
...
export const LineTargetAnchor = memo(LineTargetAnchorComponent);
